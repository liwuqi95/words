...
class TestRecordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test_record" do
    assert_difference('TestRecord.count') do
      post test_records_url, params: { test_record: { result: @test_record.result, test_id: @test_record.test_id, word_id: @test_record.word_id } }
    end
  ...
  test "should update test_record" do
    patch test_record_url(@test_record), params: { test_record: { result: @test_record.result, test_id: @test_record.test_id, word_id: @test_record.word_id } }
