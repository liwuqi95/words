...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { library_id: @test.library_id, user_id: @test.user_id } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { library_id: @test.library_id, user_id: @test.user_id } }
