...
class ChaptersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post chapters_url, params: { chapter: { library_id: @chapter.library_id, name: @chapter.name } }
    end
  ...
  test "should update chapter" do
    patch chapter_url(@chapter), params: { chapter: { library_id: @chapter.library_id, name: @chapter.name } }
